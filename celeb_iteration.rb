#hashes operation like dictionaries... they hold #keys, which are like words in the dictionary
  # "Coco" => "Dylan O'Brian",
  # "Persia"=> "Cole Sprouse",
  # "Val" => "Cole Sprouse",dictionary, and those keys have a value, which is like their defination 
#in an array, the keys are numbers (0, 1, yeah) ... this is different than a hash
